...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/entities/items/{item_id}/labels_with_language_fallback/{language_code}".format(
            item_id=item_id,
...
async def asyncio_detailed(
    ...
    *,
    ...
    response = await client.get_async_httpx_client().request(follow_redirects=follow_redirect, **kwargs)
