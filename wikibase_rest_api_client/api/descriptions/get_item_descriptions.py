...
from ...models import Error, ItemDescriptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/entities/items/{item_id}/descriptions".format(
            item_id=item_id,
        ),
    }
...
) -> Optional[Union[ItemDescriptions, Error]]:
    if response.status_code == HTTPStatus.OK:
        return ItemDescriptions.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ItemDescriptions, Error]]:
    return Response(
