...
from ...models import Error, PropertyDescriptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/entities/properties/{property_id}/descriptions".format(
...
) -> Optional[Union[PropertyDescriptions, Error]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PropertyDescriptions, Error]]:
    return Response(
