...
T = TypeVar("T", bound="StatementPatchRequest")


@_attrs_define
class StatementPatchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        statement_patch_request.additional_properties = d
        return statement_patch_request
