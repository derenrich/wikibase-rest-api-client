...
T = TypeVar("T", bound="AliasesPatchRequest")


@_attrs_define
class AliasesPatchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aliases_patch_request.additional_properties = d
        return aliases_patch_request
